...
ksemillas  <- c(800021 , 800029 , 800033 , 800053 , 800057 ) #reemplazar por las propias semillas
...
{
  for( vmin_split  in  c(  10, 20, 40, 80, 160, 320, 640, 700, 800, 900, 1000 )  ) 
  {
    for( vcp  in  c( -1,-0.5)  )  
    {
      for( vmin_bucket  in  c( 2, 4, 8, 16, 32, 100, 150, 200, 250, 300)  )
      {
